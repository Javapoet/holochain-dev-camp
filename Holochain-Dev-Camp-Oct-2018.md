# Holochain Dev Camp Oct 2018

## Holochain Team
- Mickki - Operations
- Chris Minnick - Tutor
- Conor Turland - Developer Training - Developer Documentation - Works with core dev team
- Eric Bear -
...
API Function we can call without our JavaScript Zome
...
DHT
A file that acts as the entry point to run a Holochain application and that contains the applications schemas and zomes.
DNA

Q. What is order of events in a token life cycle?
...
Controlling the way a currency system works enables you to manipulate:
...
[dna-to-openapi](https://github.com/holochain/dna-to-openapi)
...
New developer preview of Holochain rewritten in Rust.
...
[rust-api](https://holochain.github.io/rust-api)
